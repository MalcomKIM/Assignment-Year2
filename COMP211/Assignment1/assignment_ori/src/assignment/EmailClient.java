...
public class EmailClient extends Frame {
	...
	class SendListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			try {
				mailMessage = new EmailMessage(fromField.getText(), toField.getText(), subjectField.getText(),
						messageText.getText(), serverField.getText(), Integer.parseInt(serverPortField.getText()));
