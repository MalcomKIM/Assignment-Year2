...
public interface IShape {
	 ...
	 * There is a simple implementation contained within Shape.java which checks for collisions between
	...
	/**
	 * Draws the shape in 2D using the AWT graphics class, see documentation for AWT to understand how to
	 ...
	 * The rotation for a positive angle will be in a anti-clockwise direction
