...
public class EmailMessage {
	 ...
	 * (From, To, Date).
	 */
	public EmailMessage(String from, String to, String subject, String text, String localServer, int localServerPort)
		...
		/*
		 * Get message. We must escape the message to make sure that there are no single
		 * periods on a line. This would mess up sending the mail.
		 */
	...
	/* For setting the content type in the MIME headers*/
